  ...
  return (
    <Box>
      ...
      >
        ...
        high market cap IPO. Analyze the massive forced buying pressure
        generated by index funds as SPCX enters the public markets with a highly
        constrained float, and understand the direct impacts these index
        rebalancing events will have on your own portfolio.
      </Typography>
          ...
          >
            <CardContent>
              ...
              <Typography variant="body2" paragraph color="text.secondary">
                ...
                This creates significant <strong>portfolio impacts</strong> for
                anyone holding these passive funds.
              </Typography>
              <Typography variant="body2" color="text.secondary">
